...
import { assignClientFacebookAccount, createClient, deleteClient, getClients, updateClient } from "../controllers/client.controller.js";
import { agencyScopeMiddleware } from "../middlewares/agencyScope.middleware.js";
import { roleMiddleware } from "../middlewares/role.middleware.js";
import { validateClientCreate, validateFacebookAccountAssignment } from "../validators/client.validator.js";
...
router.patch("/:agencyId/:clientId/facebook-accounts", roleMiddleware("admin", "team"), validateFacebookAccountAssignment, assignClientFacebookAccount);
