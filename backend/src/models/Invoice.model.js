...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    budget: {
      ...
      currency: { type: String, enum: ["USD", "BDT", "INR"], default: "USD" },
    },
    ...
    paymentMethod: { type: String, enum: ["cash", "bank", "bkash", "nagad", "stripe", "manual", ""], default: "" },
...
invoiceSchema.index({ agency: 1, adRequest: 1 }, { unique: true });
