...
const campaignSchema = new mongoose.Schema(
  {
    ...
    performance: {
      ...
      actions: [{ actionType: { type: String, trim: true }, value: { type: Number, min: 0, default: 0 } }],
      ctrAll: { type: Number, min: 0, default: 0 },
      amountSpent: { type: Number, min: 0, default: 0 },
      currency: { type: String, trim: true, default: "" },
      delivery: { type: String, trim: true, default: "" },
      sourceCurrency: { type: String, trim: true, default: "" },
      usdConversionAvailable: { type: Boolean, default: false },
